...
const BottomFooter = ["Chính sách bảo mật", "Chính sách cookie", "Điều khoản sử dụng"];
const Resources = [
  "Yoga cho người mới bắt đầu",
  "Yoga cho người có kinh nghiệm",
  "Yoga nâng cao cho người học lâu năm",
  "Các bài tập nâng cao",
];
const Plans = ["Thành viên trả phí", "Dành cho sinh viên", "Giải pháp doanh nghiệp"];
const Community = ["Diễn đàn", "Câu lạc bộ", "Sự kiện"];
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              <h1 className="text-richblack-50 font-semibold text-[16px]">Tài nguyên</h1>
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="flex items-center">
            <a href="https://github.com/MinhTam17062003/HeathyLife.git" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/MinhTam17062003/HeathyLife.git" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
